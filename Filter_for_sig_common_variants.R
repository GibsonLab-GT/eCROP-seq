...
i_sig<- i_sig %>% distinct(X.Gene., .keep_all = T) #to get accurate count of controls which were included in each pool, add "filename" here

i_dis <- i %>% distinct(X.Gene.,.keep_all = T) #to get accurate count of controls which were included in each pool, add "filename" here
